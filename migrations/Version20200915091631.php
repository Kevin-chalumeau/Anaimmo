 ...
 */
final class Version20200915091631 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sale (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(255) NOT NULL, mandat_number INT NOT NULL, type VARCHAR(255) NOT NULL, annonce_title VARCHAR(255) NOT NULL, price_fai INT NOT NULL, net_seller_price INT NOT NULL, pourcentage DOUBLE PRECISION NOT NULL, honorary INT NOT NULL, living_area INT NOT NULL, land_area INT NOT NULL, descriptif LONGTEXT NOT NULL, city VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
